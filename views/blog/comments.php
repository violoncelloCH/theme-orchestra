...
<script id="comments-item" type="text/template">
    ...
    <li :id="'comment-'+comment.id">
        ...
        <article class="uk-comment uk-card-body uk-card-secondary uk-card-hover" >
            ...
            <header class="uk-comment-header uk-grid-medium uk-flex-middle" uk-grid>
              ...
              <div class="uk-width-expand">
                ...
                <p class="uk-comment-meta uk-margin-remove" v-if="comment.status">
...
<script id="comments-reply" type="text/template">
    ...
    <div class="uk-margin-large-top js-comment-reply">
        ...
        <form class="uk-container" v-if="user.canComment" v-validator="form" @submit.prevent="save | valid">
            ...
            <template v-else>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input id="form-name" class="uk-input uk-form-width-large" type="text" name="author" v-model="author" v-validate:required>

                        <p class="uk-text-danger" v-show="form.author.invalid">{{ 'Name cannot be blank.' | trans }}</p>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input id="form-email" class="uk-input uk-form-width-large" type="email" name="email" v-model="email" v-validate:email>

                        <p class="uk-text-danger" v-show="form.email.invalid">{{ 'Email invalid.' | trans }}</p>
                    </div>
                </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-form-controls">
                    <textarea id="form-comment" class="uk-textarea uk-width-1-1" name="content" rows="10" v-model="content" v-validate:required></textarea>

                    <p class="uk-text-danger" v-show="form.content.invalid">{{ 'Comment cannot be blank.' | trans }}</p>
                </div>
            </div>

            <p>
                <button class="uk-button uk-button-primary" type="submit" accesskey="s">{{ 'Submit' | trans }}</button>
                <button class="uk-button uk-button-default" accesskey="c" v-if="parent" @click.prevent="cancel">{{ 'Cancel' | trans }}</button>
            </p>
