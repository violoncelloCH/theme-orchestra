...
<form class="uk-container" action="<?= $view->url('@user/authenticate') ?>" method="post">

    <div class="uk-margin">
        <input class="uk-input uk-width-1-1" type="text" name="credentials[username]" value="<?= $this->escape($last_username) ?>" placeholder="<?= __('username') ?>">
    </div>

    <div class="uk-margin">
        <input class="uk-input uk-width-1-1" type="password" name="credentials[password]" value="" placeholder="<?= __('password') ?>">
    </div>
