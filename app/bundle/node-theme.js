...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  methods: {
	    deleteLink: function deleteLink(key) {
	      this.node.theme.about_video_links.splice(key, 1);
	    },
	    addLink: function addLink() {
	      this.node.theme.about_video_links.push(this.newLink);
	      this.newLink = '';
	    }
